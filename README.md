...
**AI Automation Developer (Contract), Appixi**  
Remote, project-based contract | February 2026 to present

- Developing parts of an outbound automation workflow with TypeScript, Next.js, Supabase, and data APIs.
- Working on company research, contact enrichment, draft generation, scoring, human review, and project documentation.

**AI and Systems Automation Intern, Delta Computers & Services Inc.**  
July 2024 to December 2024

- Assisted the engineering lead with testing and data validation for Delta CORE, a system that processed more than 50,000 emails, 1,900 invoices, 1,400 wire records, and five years of business data. The system cut manual data entry by more than 20 hours per week.
- Checked extracted data and RAG pricing results against more than 54,000 source records, logged mismatches, and helped confirm recommendations returned in under two seconds before human approval.
- Assisted with output testing and documentation for a local AI system. Keeping company documents off external LLM services was estimated to save about $2,000 per month.
...
- **Applications and data:** FastAPI, Next.js, React, Node.js, PostgreSQL, Supabase, Pandas
- **Cloud and tools:** AWS, REST APIs, Git, GitHub, Docker
- **Applied AI study:** LLM APIs, structured outputs, RAG, evaluation, LangGraph, MCP, human review, security, and AWS deployment
...
- [Portfolio](https://isha-imran-portfolio.vercel.app/)
- [LinkedIn](https://www.linkedin.com/in/isha-imran1984)
